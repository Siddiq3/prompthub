  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={`min-w-0 flex-1 bg-transparent text-sm text-slate-800 outline-none placeholder:text-slate-400 dark:text-slate-100 dark:placeholder:text-slate-500 sm:text-[0.96rem] ${inputClassName}`}
      />
      {showButton ? (
        <button
          type="submit"
