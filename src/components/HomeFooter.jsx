...
export default function HomeFooter({ popularCategories }) {
    ...
    <footer className="w-full bg-slate-900 dark:bg-black border-t border-slate-800">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          {/* Popular Categories */}
          <div className="space-y-4">
            <h4 className="text-white font-semibold text-sm">Top Categories</h4>
            <ul className="space-y-2">
          ...
          {/* Support & Legal */}
          <div className="space-y-4">
            <h4 className="text-white font-semibold text-sm">Support & Legal</h4>
            <ul className="space-y-2">
              <li>
